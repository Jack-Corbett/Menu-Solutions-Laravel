...
@section('content')
    ...
    <div class="padding-bottom container center dark-grey">
        <div class="quarter padding">
            ...
            <img src="{{ asset('img/clock.png') }}" class="image" style="width:80%">
        ...
        <div class="quarter padding">
            ...
            <img src="{{ asset('img/calendar.png') }}" class="image" style="width:80%">
        ...
        <div class="quarter padding">
            ...
            <img src="{{ asset('img/list.png') }}" class="image" style="width:80%">
        ...
        <div class="quarter padding">
            ...
            <img src="{{ asset('img/platekf.png') }}" class="image" style="width:80%">
